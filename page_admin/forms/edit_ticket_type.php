                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <select class="form-control" name ="trangthai">
                                <option value="1" <?php if( $row_ticket_type[0]['status']==1) echo "selected = 'selected'";?> >Đang sử dụng</option>
                                <option value="0" <?php if( $row_ticket_type[0]['status']==0) echo "selected = 'selected'";?>>Hết hạn sử dụng</option>
                            </select>
                          </div>
                        </div>
                      </div>
