                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="<?php echo '../forms/account/add_account_process.php' ?> " method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                      ...
                      <input type="text" value="<?php echo isset($data['tentaikhoan']) ? $data['tentaikhoan'] : ''; ?>" class="form-control" name="tentaikhoan" id="exampleInputName1" placeholder="Tên đăng nhập">
                      <?php echo isset($error['tentaikhoan']) ? $error['tentaikhoan'] : ''; ?>
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" name="create" class="btn btn-primary me-2">Tạo</button>
